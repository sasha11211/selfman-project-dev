...
public class ProviderController{
	...
	public void changePasswordProvider(@RequestBody ProviderChangePasswordDto providerChangePasswordDto) {
		providerService.changePasswordProvider(providerChangePasswordDto);
	}
